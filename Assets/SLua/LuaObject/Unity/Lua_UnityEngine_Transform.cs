...
public class Lua_UnityEngine_Transform : LuaObject {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int OverlayPosition(IntPtr l) {
		try {
			int argc = LuaDLL.lua_gettop(l);
			if(argc==2){
				UnityEngine.Transform self=(UnityEngine.Transform)checkSelf(l);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int SetChildLayer(IntPtr l) {
		try {
			UnityEngine.Transform self=(UnityEngine.Transform)checkSelf(l);
			System.Int32 a2;
			checkType(l,2,out a2);
			self.SetChildLayer(a2);
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int DestroyChildren(IntPtr l) {
		try {
			UnityEngine.Transform self=(UnityEngine.Transform)checkSelf(l);
