...
public class Lua_UnityEngine_Camera : LuaObject {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int FitOnScreen(IntPtr l) {
		try {
			int argc = LuaDLL.lua_gettop(l);
			if(argc==3){
				UnityEngine.Camera self=(UnityEngine.Camera)checkSelf(l);
				...
				self.FitOnScreen(a2,a3,a4,out a5);
				pushValue(l,true);
				pushValue(l,a5);
				return 2;
			}
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function FitOnScreen to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int GetWorldCorners(IntPtr l) {
		try {
			...
			if(argc==1){
				...
				UnityEngine.Transform a2;
				checkType(l,2,out a2);
				var ret=self.GetWorldCorners(a2);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
				...
				UnityEngine.Transform a3;
				checkType(l,3,out a3);
				var ret=self.GetWorldCorners(a2,a3);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
